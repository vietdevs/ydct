...
namespace newPSG.PMS.Authorization.Users
{
    public interface IUserEmailer
    {
        ...
        #region Custom 
        Task SendEmailConfirmRegisterAsync(User user);
        Task SendEmailDoNotExceptRegisterAsync(User user, string lyDoKhongDuyet);
        Task SendEmailDeactiveUserAccountAsync(User user);
        Task SendEmailActiveUserAccountAsync(User user);
        #endregion
