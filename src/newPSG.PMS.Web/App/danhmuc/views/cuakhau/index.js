(function () {
    appModule.controller('danhmuc.views.cuakhau.index', [
        '$scope', '$uibModal', '$stateParams', 'uiGridConstants', 'abp.services.app.cuaKhau', 'appSession',
        function ($scope, $uibModal, $stateParams, uiGridConstants, cuaKhauService, appSession) {
            //variable
            var vm = this;
            vm.loading = false;
            vm.requestParams = {
            ...
            function openCreateOrEditChucVuModal(cuakhau) {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/danhmuc/views/cuakhau/createOrEditModal.cshtml',
                    controller: 'danhmuc.views.cuakhau.createOrEditModal as vm',
                    backdrop: 'static',
                    resolve: {
                        cuakhau: cuakhau
                    }
