(function () {
    appModule.controller('quanlytaikhoan.chuyengia.index', [
        ...
        function ($scope, $uibModal, $stateParams, uiGridConstants, quanLyTK, appSession) {
            ...
            vm.filterDefault = {
                ...
                pageSize: 10,
                filter: null,
                loaiTaiKhoan: app.LOAI_TAI_KHOAN.TAI_KHOAN_CHUYEN_GIA 
            };
            ...
            function openCreateOrEditUserModal(userId) {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/quanlytaikhoan/chuyengia/createOrEditModal.cshtml',
                    controller: 'quanlytaikhoan.chuyengia.createOrEditModal as vm',
                    backdrop: 'static',
                    resolve: {
                        data: {
                            userId: userId,
