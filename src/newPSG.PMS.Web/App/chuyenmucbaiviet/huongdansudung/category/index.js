(function () {
    appModule.controller('chuyenmucbaiviet.huongdansudung.category.index', [
        ...
        function ($rootScope, $scope, $uibModal, $stateParams, uiGridConstants, categoryService, appSession) {
            ...
            vm.categoryColumns = [
                ...
                },
                {
                    ...
                    title: "Xóa",
                    width: "50px",
                    template: "<a class='font-red-flamingo ablock text-center' ng-click='vm.xoaCategory(this.dataItem)'><i class='fa fa-trash'></i></a>"
                },
                {
                    field: "",
                    title: "Sửa",
                ...
                },
                {
                    ...
                    title: "Thao tác",
                    width: "180px",
                    template: `<p style="margin: 0;text-align:center;" ng-if="this.dataItem.file"><a href='{{this.dataItem.file}}'><i class='fa fa-download'> Tải file</a></p>`,
                },
                {
                    field: "isActive",
                    title: "Trạng Thái",
            ...
            vm.categoryGridOptions = new kendo.data.DataSource({
                transport: {
                    read: function (options) {
                        ...
                        vm.loading = true;
                        categoryService.getAllServerPagingLevel($.extend({ filter: vm.filter.Filter, roleLevel: vm.filter.RoleLevel }, vm.requestParams))
            ...
            vm.suaCategory = function (category) {
                ...
                categoryCopy.title = categoryCopy.title.replace('---', '').replace(' ---', '');
