(function () {
    appModule.directive('quanlyhoso.thutuc98.directives.viewtailieu', ['$compile', '$sce', '$templateRequest',
        'abp.services.app.xuLyHoSoView98',
        ...
        function ($compile, $sce, $templateRequest,
                    ...
                    if (vm.lstCongVan.length > 0) {
                        ...
                        if (item != null) {
                            ...
                            if (!baseService.isNullOrEmpty(item.duongDanTepCA) && item.lanhDaoCucIsCA == true) {
                                ...
                                vm.congVanUrl = "/Report98/TemplateCongVan?hoSoId=" + item.hoSoId + "#zoom=70";
                            }
                        }
                    }
                };
                ...
                var init = function () {
                    xuLyHoSoViewService.getViewHoSo(vm.dataItem.id).then(function (result) {
                        if (result.data) {
                            ...
                            //    vm.bienBanThamDinhUrl = "/Report98/TemplateBienBanThamDinh?hoSoId=" + vm.dataItem.id + "#zoom=70";
                            //}
            ...
            return {
                ...
                link: function (scope, elem, attr, ctrl) {
                    $templateRequest("/App/quanlyhoso/thutuc98/directives/viewTaiLieu.cshtml").then(function (html) {
