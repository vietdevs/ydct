(function () {
    appModule.directive('quanlyhoso.thutuc98.directives.util.viewbienbanthamdinh', ['$compile', '$templateRequest', 'abp.services.app.xuLyHoSoChuyenVien98',
        function ($compile, $templateRequest, xuLyHoSoChuyenVienService) {

            var controller = ['$scope', function ($scope) {
                var vm = this;
                vm.QUI_TRINH_THAM_DINH = app.QUI_TRINH_THAM_DINH;
                vm.LOAI_DON_HANG = app.LOAI_HO_SO_TW98;
            ...
            return {
                ...
                link: function (scope, elem, attr, ctrl) {
                    $templateRequest("/App/quanlyhoso/thutuc98/directives/util/viewBienBanThamDinh.cshtml").then(function (html) {
