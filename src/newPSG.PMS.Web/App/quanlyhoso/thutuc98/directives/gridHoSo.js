(function () {
    appModule.directive('quanlyhoso.thutuc98.directives.gridhoso', ['$compile', '$templateRequest',
        'abp.services.app.xuLyHoSoGridView98', 'abp.services.app.xuLyHoSoDoanhNghiep98', 'abp.services.app.xuLyHoSoTruongPhong98', 'abp.services.app.xuLyHoSoLanhDaoCuc98', 'abp.services.app.xuLyHoSoVanThu98',
        ...
        function ($compile, $templateRequest, xuLyHoSoGridViewService, xuLyHoSoDoanhNghiepService, xuLyHoSoTruongPhongService, xuLyHoSoLanhDaoCucService, xuLyHoSoVanThuService, appSession, appChuKySo) {
            var controller = ['$rootScope', '$scope', '$uibModal',
                function ($rootScope, $scope, $uibModal) {
                        ...
                        //Gridview
                        {
                            vm.refreshColumns = function () {
                                            ...
                                            _colthaotac.template =
                                                ...
                                                <div class="btn-group dropdown" uib-dropdown="" dropdown-append-to-body>
                                                    ...
                                                    <ul uib-dropdown-menu busy-if= "vm.action_loading">
                                                        ...
                                                        <li><a ng-click="vm.nopHoSoMoi(this.dataItem)"  ng-if="vm.arrExist(this.dataItem.arrChucNang, 14)"><em class="fa fa-paper-plane-o"></em> Nộp hồ sơ</a></li>
                                ...
                                var _colNgayHenTra = {
                                    ...
                                    <div ng-if="this.dataItem.trangThaiHoSo == 4">
                                ...
                                var _colKetQua = {
                                    ...
                                    , template: "<div class='label bg-green-jungle bg-font-green-jungle' ng-show='this.dataItem.hoSoIsDat == true'>Hồ sơ đạt</div>"
                                        + "<div class='label label-danger' ng-show='this.dataItem.hoSoIsDat == false'>Hồ sơ cần SĐBS</div>"
                                        + "<span class='label bg-purple-medium' ng-show='vm.isTruongPhong && this.dataItem.truongPhongDaDuyet == true && this.dataItem.hoSoIsDat == null'>Đang theo dõi</span>"
                                    , width: 120
                                };
                                ...
                                var setColForForm = function () {
                                    switch (vm.form) {
                                        case 'dang_ky_ho_so':
                                            ...
                                            break;
                                        case 'mot_cua_ra_soat':
                                            vm.columns = [_stt, _thaotac(), _thongtinHoSo, _colNgayNop, _colNgayHenTra, _colDonViGui, _colDonViXuLy];
                                            break;
                                        case 'truong_phong_duyet':
                                        ...
                                        case 'van_thu_duyet':
                                            vm.columns = [_stt, _checkBoxChonNhieu(),
                                                _colShortThongTinHoSoVanThuDuyet, _colNgayNop, _colNgayHenTra, _colDonViGui, _colDonViXuLy, _colKetQua];
                                            break;
                                    }
                                };
                                setColForForm();
                                        ...
                                        if (result) {
                                            if (vm.listFormCase.length < 1) {
                                                ...
                                                if (vm.filter.formId == app.FORM_ID.FORM_DANG_KY_HO_SO) {
                                                    vm.listFormCase = vm.listFormCase.filter(x => x.id == 0 || x.id == 1 || x.id == 6 || x.id == 7 || x.id == 8);
                                                    vm.listFormCase[2].name = "Hồ sơ đang xử lý";
                                                }
                                                else if (vm.filter.formId == app.FORM_ID.FORM_MOT_CUA_RA_SOAT) {
                                                    vm.listFormCase = vm.listFormCase.filter(x => x.id == 0 || x.id == 1 || x.id == 3 || x.id == 5);
                                                    vm.listFormCase[3].name = "Hồ sơ đã trả kết quả";
                                                    vm.listFormCase[2].name = "Hồ sơ cần bổ sung";
                                                } else if (vm.filter.formId == app.FORM_ID.FORM_TRUONG_PHONG_DUYET) {
                                                    vm.listFormCase = vm.listFormCase.filter(x => x.id == 0 || x.id == 1 || x.id == 4);
                                                    vm.listFormCase[1].name = "Hồ sơ chờ duyệt";
                                                }
                                            }
                                            else {
                    ...
                    //--- Functions Common ---//
                    {
                        ...
                        vm.xemHoSoFull = function (dataItem) {
                            if (dataItem && dataItem.id > 0) {
                                ...
                                var modalInstance = $uibModal.open({
                                    templateUrl: '~/App/quanlyhoso/thutuc98/directives/modal/viewHoSoFullModal.cshtml',
                                    controller: 'quanlyhoso.thutuc98.directives.modal.viewHoSoFullModal as vm',
                                    backdrop: 'static',
                                    size: 'lg',
                                    resolve: {
                                        modalData: modalData
                        ...
                        vm.nopHoSoMoi = function (dataItem) {
                            abp.message.confirm(app.localize('Thông tin hồ sơ "' + dataItem.maHoSo + '" sẽ được gửi !!!'),
                                ...
                                function (isConfirmed) {
                                    if (isConfirmed) {
                                        abp.ui.setBusy();
                                        xuLyHoSoDoanhNghiepService.nopHoSoMoi(dataItem.id)
                                            .then(function (result) {
                                                if (result) {
                        ...
                        vm.xemCongVan = function (dataItem) {
            ...
            return {
                ...
                link: function (scope, elem, attr, ctrl) {
                    $templateRequest("/App/quanlyhoso/thutuc98/directives/gridHoSo.cshtml").then(function (html) {
