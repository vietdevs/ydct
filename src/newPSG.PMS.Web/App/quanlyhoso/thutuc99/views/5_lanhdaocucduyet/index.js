(function () {
    appModule.controller('quanlyhoso.thutuc99.views.lanhdaocucduyet.index', [
        '$rootScope', '$sce', '$uibModal', 'appSession', 'quanlyhoso.thutuc99.services.appChuKySo', 'abp.services.app.xuLyHoSoLanhDaoCuc99', 
        function ($rootScope, $sce, $uibModal, appSession, appChuKySo, xuLyHoSoLanhDaoCucService) {
            ...
            vm.dataItem = {};
            vm.openLanhDaoDuyet = function (dataItem) {
                    ...
                    xuLyHoSoLanhDaoCucService.loadLanhDaoCucDuyet(params)
                        .then(function (result) {
                            ...
                            if (result.data) {
                                ...
                                vm.pathGiayTiepNhan = "/Report99/TemplateCongVan?hoSoId=" + dataItem.id;
                                vm.show_mode = 'lanh_dao_cuc_duyet';
                            }
                        });
                }
            };
                    ...
                    if (vm.dataItem && vm.dataItem.id > 0) {
                        ...
                        if (vm.dataItem.hoSoIsDat == true) {
                            ...
                            appChuKySo.kySoCongVan(vm.dataItem, function (paramKySo) {
                                ...
                                duyetHoSo.giayTiepNhanCA = paramKySo.duongDanTep;
                                ...
                                xuLyHoSoLanhDaoCucService.kyVaChuyenVanThu(duyetHoSo)
                                    .then(function (result) {
                                        ...
                                        appChuKySo.xemFilePDF(paramKySo.duongDanTep, 'Giấy chứng nhận đã ký số');
            ...
            vm.chuyenLaiTruongPhong = function () {
                ...
                if (!flagNull || !flag) {
                    ...
                    vm.saving = true;
                    xuLyHoSoLanhDaoCucService.chuyenLaiTruongPhong(vm.duyetHoSo)
                        .then(function (result) {
                            if (result.data) {
                                vm.saving = false;
            ...
            vm.xemTaiLieuFull = function (dataItem) {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/quanlyhoso/thutuc99/directives/modal/fullDocumentModal.cshtml',
                    controller: 'quanlyhoso.thutuc99.directives.modal.fullDocumentModal as vm',
                    backdrop: 'static',
                    size: 'lg',
                    resolve: {
                        modalData: modalData
