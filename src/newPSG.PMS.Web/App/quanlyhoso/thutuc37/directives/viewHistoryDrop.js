(function () {
    appModule.directive('quanlyhoso.thutuc37.directives.viewhistorydrop', ['$compile', '$templateRequest', 'abp.services.app.xuLyHoSoView37', 'appSession',
        function ($compile, $templateRequest, xuLyHoSoViewService, appSession) {
            ...
            var controller = ['$scope', '$uibModal', 'baseService', function ($scope, $uibModal, baseService) {
                ...
                vm.xemChiTiet = function (item) {
                    var modalInstance = $uibModal.open({
                        templateUrl: '~/App/quanlyhoso/thutuc37/directives/modal/viewHistoryChiTietModal.cshtml',
                        controller: 'quanlyhoso.thutuc37.directives.modal.viewHistoryChiTietModal as vm',
                        backdrop: 'static',
                        size: 'lg',
                        resolve: {
                            modalData: {
            ...
            return {
                ...
                link: function (scope, elem, attr, ctrl) {
                    $templateRequest("/App/quanlyhoso/thutuc37/directives/viewHistoryDrop.cshtml").then(function (html) {
