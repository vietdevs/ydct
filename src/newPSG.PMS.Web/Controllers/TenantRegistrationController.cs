...
using newPSG.PMS.Web.Models.TenantRegistration;
using Recaptcha.Web;
...
{
    public class TenantRegistrationController : PMSControllerBase
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.PasswordComplexitySetting = SettingManager.GetSettingValue(AppSettings.Security.PWComplexity).Replace("\"", "");
