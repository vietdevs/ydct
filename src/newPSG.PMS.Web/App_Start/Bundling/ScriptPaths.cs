...
namespace newPSG.PMS.Web.Bundling
{
    ...
    {
        #region FRONTEND CHI CUC Modernizr

        public const string AModernizr = "~/libs/assets/js/modernizr-2.8.3.min.js";

        #endregion FRONTEND CHI CUC Modernizr

        #region FRONTEND CHI CUC Modernizr

        public const string AJquery = "~/libs/assets/js/jquery-1.12.0.min.js";
        public const string ABootstrap = "~/libs/assets/js/bootstrap.min.js";
        public const string AWow = "~/libs/assets/js/wow.min.js";
        public const string AMeanMenu = "~/libs/assets/js/jquery.meanmenu.js";
        public const string AScrollUp = "~/libs/assets/js/scrollup.js";
        public const string AManificPopup = "~/libs/assets/js/jquery.magnific-popup.js";
        public const string ACounterUp = "~/libs/assets/js/jquery.counterup.min.js";
        public const string AWayPoints = "~/libs/assets/js/waypoints.min.js";
        public const string AAppear = "~/libs/assets/js/jquery.appear.js";
        public const string ACarousel = "~/libs/assets/js/owl.carousel.min.js";
        public const string AMain = "~/libs/assets/js/attp-script.js";
        ...
        public const string JQuery_Slimscroll = "~/libs/jquery-slimscroll/jquery.slimscroll.js";
        public const string JQuery_Slimscroll_Min = "~/libs/jquery-slimscroll/jquery.slimscroll.min.js";
        ...
        public const string Bootstrap_Fileinput = "~/libs/bootstrap-fileinput/bootstrap-fileinput.js";
        ...
        public const string Kendo = "~/libs/kendoui/js/kendo.all.min.js";

        public const string FormValidation = "~/libs/formvalidation-extend/js/formValidation.min.js";
        public const string FormValidation_BootstrapExtend = "~/libs/formvalidation-extend/js/bootstrapextend.min.js";

        public const string Bootstrap_Summernote = "~/libs/bootstrap-summernote/summernote.min.js";
        ...
        public const string Angular_Aria = "~/Scripts/angular-aria.min.js";//SPA!
        public const string Angular_Messages = "~/Scripts/angular-messages.min.js";//SPA!
        ...
        public const string Angular_Kendo = "~/libs/kendoui/js/angular-kendo.min.js";//SPA!
        public const string KendoMVC = "~/libs/kendoui/js/kendo.aspnetmvc.min.js";//SPA!
        ...
        public const string Angular_DropDown_MultiSelect = "~/libs/angularjs-dropdown-multiselect/angularjs-dropdown-multiselect.js";//SPA!
        public const string Angular_Bootstrap_MultiSelect = "~/libs/angular-bootstrap-multiselect/js/bootstrap-multiselect.min.js";//SPA!
        public const string Angular_Content_Editable = "~/libs/angular-content-editable/angular-content-editable.min.js";//SPA!
        public const string Pdf_Js = "~/libs/angular-pdf-viewer/js/pdf.js";//SPA!
        public const string Angular_Pdf_Viewer = "~/libs/angular-pdf-viewer/js/angular-pdfjs-viewer.js";//SPA!
        public const string Angular_Linqjs = "~/libs/angular-linqjs/angular-linq.min.js";//SPA!
        public const string Angular_Input_Masks_StandAlone = "~/libs/angular-input-masks-standalone/angular-input-masks-standalone.min.js";//SPA!
        public const string ChartJS = "~/libs/chartjs/Chart.js";//SPA!

        public const string Angular_Bootstrap_Summernote = "~/libs/bootstrap-summernote-angular/angular-summernote.min.js";

        public const string Angular_Material = "~/libs/angular-material/js/angular-material.min.js";
