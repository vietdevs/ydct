(function () {
    ...
    appModule.controller('quanlytaikhoan.canbocuc.index', [
        ...
        function ($scope, $uibModal, $stateParams, uiGridConstants, quanLyTK, appSession) {
            ...
            vm.filterDefault = {
                ...
                pageSize: 10,
                filter: null,
                loaiTaiKhoan: app.LOAI_TAI_KHOAN.TAI_KHOAN_CUC 
            };
            ...
            function openCreateOrEditUserModal(userId) {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/quanlytaikhoan/canbocuc/createOrEditModal.cshtml',
                    controller: 'quanlytaikhoan.canbocuc.createOrEditModal as vm',
                    backdrop: 'static',
                    resolve: {
                        data: {
                            userId: userId,
