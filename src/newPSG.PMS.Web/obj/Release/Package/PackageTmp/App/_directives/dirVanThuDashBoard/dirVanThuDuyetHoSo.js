(function () {
    appModule.directive('app.directives.dirvanthuduyethoso', ['$compile', '$timeout', '$templateRequest', '$filter', 'appSession', '$linq',
        function ($compile, $timeout, $templateRequest, $filter, appSession, $linq) {
            ...
            return {
                ...
                link: function (scope, elem, attr, ctrl) {
                    $templateRequest("/App/_directives/dirVanThuDashBoard/dirVanThuDuyetHoSo.html").then(function (html) {
