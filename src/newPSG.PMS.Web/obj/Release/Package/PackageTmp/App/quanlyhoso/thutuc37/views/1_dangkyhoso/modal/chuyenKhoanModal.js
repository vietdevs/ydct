(function () {
    appModule.controller('quanlyhoso.thutuc37.views.dangkyhoso.modal.chuyenKhoanModal', [
        '$uibModalInstance','$sce', 'dataItem', 'FileUploader', 'abp.services.app.xuLyHoSoDoanhNghiep37', 'baseService', 'appSession',
