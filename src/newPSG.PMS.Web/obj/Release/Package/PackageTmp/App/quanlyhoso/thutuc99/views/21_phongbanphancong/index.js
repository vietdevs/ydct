(function () {
    appModule.controller('quanlyhoso.thutuc99.views.phongbanphancong.index', [
        '$rootScope', 'abp.services.app.xuLyHoSoPhanCong99',
        'appSession', 'quanlyhoso.thutuc99.services.appChuKySo',
        function ($rootScope, xuLyHoSoPhanCongService,
            ...
            vm.phanCongInfo_Reset = function () {
                vm.phanCongInfo = {
                    arrHoSoId: [],
                    truongPhongId: vm.truongPhongId,
                    phoPhongId: null,
                    chuyenVienThuLyId: null,
                    chuyenVienPhoiHopId: null,
                    isHoSoUuTien: null,
            ...
            vm.luuPhongBanPhanCong = function () {
                var rep = angular.copy(vm.phanCongInfo);
