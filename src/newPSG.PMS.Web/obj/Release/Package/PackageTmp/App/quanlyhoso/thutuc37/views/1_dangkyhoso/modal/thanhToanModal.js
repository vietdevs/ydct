(function () {
    appModule.controller('quanlyhoso.thutuc37.views.dangkyhoso.thanhToanModal', [
        '$scope', '$uibModalInstance', '$window', '$uibModal', 'dataItem',
        'abp.services.app.loaiHoSo', 'abp.services.app.xuLyHoSoDoanhNghiep37', 'appSession',
        function ($scope,$uibModalInstance, $window, $uibModal, dataItem,
            ...
            //Xử lý thanh toán
            {
                ...
                vm.chuyenKhoanModal = function (data) {
                    var modalInstance = $uibModal.open({
                        templateUrl: '~/App/quanlyhoso/thutuc37/views/1_dangkyhoso/modal/chuyenKhoanModal.cshtml',
                        controller: 'quanlyhoso.thutuc37.views.dangkyhoso.modal.chuyenKhoanModal as vm',
                        backdrop: 'static',
                        size: 'lg',
                        resolve: {
                            dataItem: data
