(function () {
    appModule.factory('quanlyhoso.thutuc98.services.appChuKySo', ['$uibModal',
        function ($uibModal) {

            //THU_TUC_ID
            var thuTucId = 98;
            //MA_THU_TUC
            var maThuTuc = app.MA_THU_TUC.THU_TUC_98;
            ...
            var xemBienBanThamDinh = function (item, fnCallBack) {
                ...
                var _pathPDF = "/Report98/TemplateBienBanThamDinh?hoSoId=" + item.id + "#zoom=70";
                ...
                if (dataItem.id > 0) {
                    $.ajax({
                        ...
                        success: function (kq) {
                            ...
                            $.ajax({
                                url: '/Report98/InsertPDFGiayTiepNhan',
                                type: 'POST',
                                async: false,
                                data: {
                                    hoSoId: dataItem.id
            ...
            var vanThuDongDau = function (dataItem, fnCallBack) {
                ...
                if (dataItem.id > 0) {
                    $.ajax({
                        url: '/Report98/GetDuongDanTepGiayCongVan',
                        type: 'POST',
                        async: false,
                        data: {
                            hoSoId: dataItem.id
