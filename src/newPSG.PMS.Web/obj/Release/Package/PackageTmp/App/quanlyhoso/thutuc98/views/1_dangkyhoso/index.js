(function () {
    appModule.controller('quanlyhoso.thutuc98.views.dangkyhoso.index', [
        '$stateParams', '$rootScope', '$uibModal', '$filter', 'abp.services.app.xuLyHoSoDoanhNghiep98',
        'FileUploader', 'baseService', 'appSession', 'quanlyhoso.thutuc98.services.appChuKySo', 'abp.services.app.loaiHoSo',
        function ($stateParams, $rootScope, $uibModal, $filter, xuLyHoSoDoanhNghiepService,
            ...
            vm.xemHuongDanDangKyCongBo = function () {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/quanlyhoso/thutuc98/views/1_dangkyhoso/modal/xemVideoHuongDan.cshtml',
                    controller: 'quanlyhoso.thutuc98.views.quanlyhoso.thutuc98.modal.xemVideoHuongDan as vm',
                    backdrop: 'static',
                    size: 'lg'
                });
            ...
            vm.addHoSo = function () {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/quanlyhoso/thutuc98/views/1_dangkyhoso/modal/selectLoaiHoSoModal.cshtml',
                    controller: 'quanlyhoso.thutuc98.views.dangkyhoso.modal.selectLoaiHoSoModal as vm',
                    backdrop: 'static',
                    resolve: {
                    },
                    size: 'lg'
                ...
                modalInstance.result.then(function (result) {
                    vm.loaiHoSoSelect = angular.copy(result);
                    vm.show_mode = 'dangkyhoso';
                    vm.hoso = vm.hosoInit();
                    vm.taiLieu = [];
                    vm.hoso.loaiHoSoId = vm.loaiHoSoSelect.id;
                });
