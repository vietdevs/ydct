(function () {
    appModule.directive('quanlyhoso.thutuc37.directives.util.bienbanthamdinh', ['$compile', '$timeout', '$templateRequest', '$filter', 'appSession',
        function ($compile, $templateRequest, appSession) {

            var controller = ['$scope', 'abp.services.app.xuLyHoSoChuyenVien37',
            ...
            return {
                ...
                link: function (scope, elem, attr, ctrl) {
                    $templateRequest("/App/quanlyhoso/thutuc37/directives/util/bienBanThamDinh.cshtml").then(function (html) {
