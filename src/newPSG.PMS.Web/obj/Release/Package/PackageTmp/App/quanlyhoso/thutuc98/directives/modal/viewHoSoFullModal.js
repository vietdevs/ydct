(function () {
    appModule.controller('quanlyhoso.thutuc98.directives.modal.viewHoSoFullModal', [
        '$sce', '$uibModalInstance', '$filter', 'modalData', 'baseService', 'abp.services.app.xuLyHoSoView98', 'appSession',
            ...
            var init = function () {
                xuLyHoSoView.getViewHoSo(vm.dataItem.id).then(function (result) {
                    if (result.data) {
                        ...
                        if (!baseService.isNullOrEmpty(vm.hoSo.giayTiepNhan)) {
                            vm.isShowGiayTiepNhan = true;
                            vm.giayTiepNhanUrl = "/File/GoToViewTaiLieu?url=" + vm.hoSo.giayTiepNhan + "#zoom=70";
                        }
