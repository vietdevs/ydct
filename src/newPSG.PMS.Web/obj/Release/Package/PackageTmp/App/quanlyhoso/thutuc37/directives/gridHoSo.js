            ...
            var controller = ['$rootScope', '$scope', '$uibModal',
                function ($rootScope, $scope, $uibModal) {
                    ...
                    //--- XuLyHoSoDoanhNghiep ---//
                    {
                        ...
                        vm.doanh_nghiep_thanh_toan = function (dataItem) {
                            var modalInstance = $uibModal.open({
                                templateUrl: '~/App/quanlyhoso/thutuc37/views/1_dangkyhoso/modal/thanhToanModal.cshtml',
                                controller: 'quanlyhoso.thutuc37.views.dangkyhoso.thanhToanModal as vm',
                                backdrop: 'static',
                                size: 'lg',
                                resolve: {
                                    dataItem: function () {
