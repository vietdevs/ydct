(function () {
    appModule.controller('quanlyhoso.thutuc99.views.vanthuduyet.index', [
        '$rootScope', '$sce', 'abp.services.app.xuLyHoSoVanThu99', 'appSession', 'quanlyhoso.thutuc99.services.appChuKySo',
                        ...
                        if (isConfirmed) {
                            ...
                            appChuKySo.vanThuDongDau(params, function (paramKySo) {
                                var params = {
                                    ...
                                    giayTiepNhanCA: vm.dataItem.hoSoIsDat == true ? paramKySo.duongDanTep : null,
                                };
                                    ...
                                    .then(function (result) {
                                        if (result.data == 0) {
                                            ...
                                            if (vm.dataItem.hoSoIsDat == true) {
                                                appChuKySo.xemFilePDF(paramKySo.duongDanTep, 'Giấy xác nhận đã ký số');
                                            }
                                            else {
