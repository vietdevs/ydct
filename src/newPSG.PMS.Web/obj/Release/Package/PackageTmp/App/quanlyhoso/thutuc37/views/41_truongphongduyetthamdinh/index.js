(function () {
    appModule.controller('quanlyhoso.thutuc37.views.truongphongduyetthamdinh.index', [
        ...
        function ($scope, $rootScope, $window, $uibModal, $interval, $filter, $sce,
            ...
            vm.dataItem = {};
            vm.form = 'truong_phong_duyet_tham_dinh';
            vm.formId = 373;
            ...
            vm.openTruongPhongDuyetThamDinh = function (dataItem) {
            ...
            vm.duyetHoSoThamDinh = function () {
                ...
                abp.message.confirm("Chắc chắn duyệt hồ sơ ?", "Duyệt hồ sơ", function (isConfirmed) {
                    if (isConfirmed) {
                        vm.saving = true;
                        xuLyHoSoTruongPhongService.truongPhongDuyetThamDinh(input)
