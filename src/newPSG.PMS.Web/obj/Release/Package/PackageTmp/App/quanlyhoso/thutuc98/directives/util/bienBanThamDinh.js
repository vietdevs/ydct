(function () {
    appModule.directive('quanlyhoso.thutuc98.directives.util.bienbanthamdinh', ['$compile', '$timeout', '$templateRequest', '$filter', 'appSession',
        function ($compile, $templateRequest, appSession) {

            var controller = ['$scope', 'abp.services.app.xuLyHoSoChuyenVien98',
            ...
            return {
                ...
                link: function (scope, elem, attr, ctrl) {
                    $templateRequest("/App/quanlyhoso/thutuc98/directives/util/bienBanThamDinh.cshtml").then(function (html) {
