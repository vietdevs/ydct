(function () {
    appModule.controller('common.views.layout.header', [
        '$rootScope', '$scope', '$uibModal', 'appSession', 'appUserNotificationHelper', 'abp.services.app.notification', 'abp.services.app.userLink', '$timeout', '$filter',
        function ($rootScope, $scope, $uibModal, appSession, appUserNotificationHelper, notificationService, userLinkService, $timeout, $filter) {
            var vm = this;
            ...
            vm.loadTenThuTuc = function () {
                vm.tenthuctuc = "Chọn thủ tục";
                vm.tenGoiThuTuc = "";
                if (!app.isNullOrEmpty($rootScope.currentMaThuTuc)) {
                    vm.tenthuctuc = "Thủ tục " + $rootScope.currentMaThuTuc;
                }
            };
            ...
            function init() {
                ...
                vm.loadTenThuTuc();
                $rootScope.$watch('currentMaThuTuc', function () {
                    $timeout(function () {
                        vm.loadTenThuTuc();
                    });
                });
