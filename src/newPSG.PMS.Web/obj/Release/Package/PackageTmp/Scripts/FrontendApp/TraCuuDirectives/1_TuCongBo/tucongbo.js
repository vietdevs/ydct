(function () {
        ...
        var controller = ['$scope', '$http', '$window',
            function ($scope, $http, $window) {
                ...
                vm.nhomSanPhamOptions = {
                    dataSource: {
                        transport: {
                            read: function (options) {
                                $http.post('/api/services/app/nhomSanPham/getAllToDDL').then(function (response) {
                    ...
                    dataValueField: "id",
                    dataTextField: "name",
                    optionLabel: app.localize('Chọn nhóm sản phẩm ...'),
                    filter: "contains"
                };
                vm.tinhOptions = {
                    dataSource: {
                    ...
                    dataSource: {
                        ...
                        transport: {
                            read: function (options) {
                                ...
                                $http.post('/api/services/app/traCuuHoSo01/getTenSanPhamCongBo', _request).then(function (ret) {
                ...
                vm.gridHoSoDataSource = new kendo.data.DataSource({
                    transport: {
                        read: function (options) {
                            ...
                            vm.loading = true;
                            $http.post('/api/services/app/traCuuHoSo01/getListHoSoTraCuuPaging', $.extend(vm.filter, vm.requestParams))
                ...
                vm.columnGridHoSo = [
                    ...
                    },
                    {
                        ...
                        title: "Nhóm sản phẩm",
                        width: "250px",
                        template: "<div>{{this.dataItem.tenNhomSanPham}}</div>"
                    },
                    {
    ...
    MyApp.directive('tracuu.dongnai.tucongbo', ['$compile', '$timeout', '$templateRequest',
        function ($compile, $timeout, $templateRequest) {
            return {
                ...
                link: function (scope, elem, attr, ctrl) {
                    $templateRequest("/Scripts/FrontendApp/TraCuuDirectives/1_TuCongBo/Index.html").then(function (html) {
    ...
    MyApp.directive('tracuu.danang.tucongbo', ['$compile', '$timeout', '$templateRequest',
        function ($compile, $timeout, $templateRequest) {
            return {
                restrict: 'EA',
                replace: true,
    ...
    MyApp.directive('tracuu.hanoi.tucongbo', ['$compile', '$timeout', '$templateRequest',
        function ($compile, $timeout, $templateRequest) {
            return {
                restrict: 'EA',
                replace: true,
    ...
    MyApp.directive('tracuu.laocai.tucongbo', ['$compile', '$timeout', '$templateRequest',
        function ($compile, $timeout, $templateRequest) {
            return {
                restrict: 'EA',
                replace: true,
    ...
    MyApp.directive('tracuu.vinhphuc.tucongbo', ['$compile', '$timeout', '$templateRequest',
        function ($compile, $timeout, $templateRequest) {
            return {
                restrict: 'EA',
                replace: true,
