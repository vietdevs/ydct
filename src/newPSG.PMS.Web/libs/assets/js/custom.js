...
if ($('#bs-example-navbar-collapse-1').length) {
    $('.dropdown a').on('click', function () {
        ...
        //$(this).parent().find('.dropdown-menus').toggleClass('dropdown-menu');
    });
}
 // ------- open menu ------- //
...
if ($('.gallery').length && $('.youtube-item').length) {
...
// ------- Home Slider Start ------- //
if ($('#tinhhinhxuly-slider').length) {
    $('#tinhhinhxuly-slider').owlCarousel({
        loop: true,
        margin: 30,
