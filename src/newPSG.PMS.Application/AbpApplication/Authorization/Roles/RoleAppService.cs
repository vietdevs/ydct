...
namespace newPSG.PMS.Authorization.Roles
{
    ...
    public class RoleAppService : PMSAppServiceBase, IRoleAppService
    {
        ...
        protected virtual async Task UpdateRoleAsync(CreateOrUpdateRoleInput input)
        {
            ...
            role.RoleLevel = input.Role.RoleLevel;
        ...
        {
            var role = new Role(AbpSession.TenantId, input.Role.DisplayName) { IsDefault = input.Role.IsDefault ,RoleLevel=input.Role.RoleLevel};
