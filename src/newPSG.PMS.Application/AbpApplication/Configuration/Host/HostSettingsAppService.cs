...
namespace newPSG.PMS.Configuration.Host
{
    ...
    public class HostSettingsAppService : PMSAppServiceBase, IHostSettingsAppService
    {
        ...
        private async Task<SecuritySettingsEditDto> GetSecuritySettingsAsync()
        {
            ...
            var defaultPasswordComplexitySetting = _settingDefinitionManager.GetSettingDefinition(AppSettings.Security.PWComplexity).DefaultValue;
