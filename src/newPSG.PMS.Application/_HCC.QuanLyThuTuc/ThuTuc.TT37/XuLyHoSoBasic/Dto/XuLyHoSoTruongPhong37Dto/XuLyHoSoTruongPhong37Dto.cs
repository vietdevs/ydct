...
{    
    public class InitTruongPhongDuyet37InputDto
    {
        public long? PhongBanId { get; set; }
        public long? UserId { get; set; }
        public int? RoleLevel { get; set; }
    }
    public class LoadTruongPhongDuyet37InputDto
    {
        public long HoSoXuLyId { get; set; }
        public long? HoSoId { get; set; }
    }
    public class LuuTruongPhongDuyet37InputDto
    {
        public long HoSoXuLyId { get; set; }
        public long? HoSoId { get; set; }

        public bool? IsTraLaiChuyenVien { get; set; }
