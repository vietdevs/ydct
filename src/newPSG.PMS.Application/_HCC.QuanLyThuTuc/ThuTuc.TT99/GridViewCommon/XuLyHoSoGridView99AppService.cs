...
{
    public interface IXuLyHoSoGridView99AppService : IApplicationService
    {
    ...
    [AbpAuthorize]
    public class XuLyHoSoGridView99AppService : PMSAppServiceBase, IXuLyHoSoGridView99AppService
    {
        ...
        public XuLyHoSoGridView99AppService(IRepository<XHoSo, long> hoSoRepos,
            ...
            try
            {
                ...
                foreach (var item in dataGrids)
                {
                        ...
                        != (int)CommonENum.TRANG_THAI_HO_SO.TU_CHOI_CAP_PHEP && item.NgayHenTra != null)
                    {
                        ...
                        {
                            SoNgayQuaHanChiTiet99Dto _soNgayQuaHanChiTiet = null;
        ...
        public IQueryable<XHoSoDto> QueryGetAllHoSo(XHoSoInputDto input)
        {
            try
            {
                ...
                var query = (from hoso in _hoSoRepos.GetAll()
                             ...
                             && (!_mySession.UserSession.DoanhNghiepId.HasValue || _mySession.UserSession.DoanhNghiepId == hoso.DoanhNghiepId)
                             && (string.IsNullOrEmpty(input.Keyword) || hoso.SoDangKy.LocDauLowerCaseDB().Contains(input.Keyword) || hoso.MaHoSo.LocDauLowerCaseDB().Contains(input.Keyword) || hoso.TenDoanhNghiep.LocDauLowerCaseDB().Contains(input.Keyword) || hoso.Id == hoSoId)
                             && (!(input.NgayNopTu.HasValue && input.NgayNopToi.HasValue) || (hoso.NgayTiepNhan >= NgayNopTu && hoso.NgayTiepNhan <= NgayNopToi))
        ...
        private IQueryable<XHoSoDto> FormDangKyHoSo(IQueryable<XHoSoDto> query, XHoSoInputDto input)
        {
            ...
            {
                query = query.Where(p => p.TrangThaiHoSo == (int)CommonENum.TRANG_THAI_HO_SO.DA_NOP_HO_SO_MOI);
            }
            if (input.FormCase == (int)CommonENum.FORM_CASE_DANG_KY_HO_SO.HO_SO_CHO_THANH_TOAN)
            {
                query = query.Where(p => p.TrangThaiHoSo == (int)CommonENum.TRANG_THAI_HO_SO.CHO_DOANH_NGHIEP_THANH_TOAN);
            }
            if (input.FormCase == (int)CommonENum.FORM_CASE_DANG_KY_HO_SO.HO_SO_DA_GUI_THANH_TOAN)
            {
                query = query.Where(p => (p.TrangThaiHoSo.HasValue ? p.TrangThaiHoSo : 0) == (int)CommonENum.TRANG_THAI_HO_SO.CHO_KE_TOAN_XAC_NHAN || (p.TrangThaiHoSo.HasValue ? p.TrangThaiHoSo : 0) == (int)CommonENum.TRANG_THAI_HO_SO.THANH_TOAN_THAT_BAI);
            }
        ...
        {
            query = query.Where(x => x.TrangThaiHoSo == (int)CommonENum.TRANG_THAI_HO_SO.MOT_CUA_TRA_LAI
                                     || x.TrangThaiHoSo == (int)CommonENum.TRANG_THAI_HO_SO.CHO_DOANH_NGHIEP_THANH_TOAN
            ...
            {
                query = query.Where(c => c.TrangThaiHoSo == (int)CommonENum.TRANG_THAI_HO_SO.DA_NOP_HO_SO_MOI);
            }
            if (input.FormCase == (int)CommonENum.FORM_CASE_MOT_CUA_RA_SOAT.HO_SO_CHO_THANH_TOAN)
            {
                query = query.Where(c => c.TrangThaiHoSo == (int)CommonENum.TRANG_THAI_HO_SO.CHO_DOANH_NGHIEP_THANH_TOAN);
            }
        ...
        private IQueryable<XHoSoDto> FormMotCuaPhanCong(IQueryable<XHoSoDto> query, XHoSoInputDto input)
        {
            var _listPhongBanLoaiHoSo = (from ploai in _phongBanLoaiHoSoRepos.GetAll()
                                         ...
                                         select new PhongBanLoaiHoSo99Dto
                                         {
        ...
        private IQueryable<XHoSoDto> FormTruongPhongDuyet(IQueryable<XHoSoDto> query, XHoSoInputDto input)
        {
            ...
            {
                query = query.Where(
                        p => p.DonViXuLy == (int)CommonENum.DON_VI_XU_LY.TRUONG_PHONG && p.TruongPhongDaDuyet != true
                        && (p.DonViGui == (int)CommonENum.DON_VI_XU_LY.PHO_PHONG || p.DonViGui == (int)CommonENum.DON_VI_XU_LY.CHUYEN_VIEN_THAM_XET_TONG_HOP)
                    );
            }
            if (input.FormCase == (int)CommonENum.FORM_CASE_TRUONG_PHONG_DUYET.HO_SO_TRA_LAI)
            {
                query = query.Where(p => p.TruongPhongDaDuyet == true &&
                           (p.DonViXuLy == (int)CommonENum.DON_VI_XU_LY.CHUYEN_VIEN_THAM_XET_TONG_HOP || p.DonViXuLy == (int)CommonENum.DON_VI_XU_LY.PHO_PHONG)
                    );
            }
            if (input.FormCase == (int)CommonENum.FORM_CASE_TRUONG_PHONG_DUYET.HO_SO_XU_LY_LAI)
            {
                query = query.Where(
                        p => p.DonViXuLy == (int)CommonENum.DON_VI_XU_LY.TRUONG_PHONG && p.TruongPhongDaDuyet == true
                    );
            ...
            if (input.FormCase == (int)CommonENum.FORM_CASE_TRUONG_PHONG_DUYET.HO_SO_DANG_THEO_DOI)
            {
                query = query.Where(
                        p => (
                        p.DonViXuLy != (int)CommonENum.DON_VI_XU_LY.TRUONG_PHONG && !(p.TruongPhongDaDuyet == true &&
                           (p.DonViXuLy == (int)CommonENum.DON_VI_XU_LY.CHUYEN_VIEN_THAM_XET_TONG_HOP || p.DonViXuLy == (int)CommonENum.DON_VI_XU_LY.PHO_PHONG))
                        )
                    );
            }
        ...
        private List<int> ArrayChucNangGridHoSo(XHoSoDto item, XHoSoInputDto input)
        {
            ...
            {
                _arrChucNang.Add((int)CommonENum.FORM_FUNCTION.XEM_HO_SO);
                if (item.DonViXuLy == (int)CommonENum.DON_VI_XU_LY.MOT_CUA_TIEP_NHAN)
                {
            ...
            else if (input.FormId == (int)CommonENum.FORM_ID.FORM_TRUONG_PHONG_DUYET)
            {
                _arrChucNang.Add((int)CommonENum.FORM_FUNCTION.XEM_HO_SO);
                _arrChucNang.Add((int)CommonENum.FORM_FUNCTION.XEM_BAN_DANG_KY);
                if (item.DonViXuLy == (int)CommonENum.DON_VI_XU_LY.TRUONG_PHONG)
                {
        ...
        private SoNgayQuaHanChiTiet99Dto TinhSoNgayQuaHanChiTiet(int _soNgayLamViec, DateTime? _ngayGui)
        {
            ...
            return new SoNgayQuaHanChiTiet99Dto()
            {
