...
{
    public class InitPhanCong99InputDto
    {
    ...
    public class MotCuaTraGiayTiepNhan99InputDto
    {
    ...
    public class PhanCongThamDinh99InputDto
    {
        public List<long> ArrHoSoId { set; get; }
