...
{
    #region INTERFACE
    public interface IXuLyHoSoLanhDaoCuc98AppService : IApplicationService
    {
        Task<dynamic> LoadLanhDaoCucDuyet(LanhDaoXuLy98Input input);
        Task<int> KyVaChuyenVanThu(LanhDaoXuLy98Input input);
        Task<int> ChuyenLaiTruongPhong(LanhDaoXuLy98Input input);
    }
    #endregion

    #region MAIN
    [AbpAuthorize]
    public class XuLyHoSoLanhDaoCuc98AppService : PMSAppServiceBase, IXuLyHoSoLanhDaoCuc98AppService
    {
        ...
        public XuLyHoSoLanhDaoCuc98AppService(IRepository<XHoSo, long> hoSoRepos,
        ...
        public async Task<int> ChuyenLaiTruongPhong(LanhDaoXuLy98Input input)
        {
            try
            {
